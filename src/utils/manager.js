 ...
 * @param language  Google language
...
export const load = (opts) => {
  ...
  if (!setUp) {
    ...
    const googleMapScript = document.getElementById('map_script');
    ...
    let baseUrl = 'https://maps.googleapis.com//maps/api/js?key=AIzaSyBvAsx_SoeYJ5kIUBDaMpyj92B8bvGt4Zw&libraries=places&language=';
    ...
    url = url + '&language=' + opts.language;
